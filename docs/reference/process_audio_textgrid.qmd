...
|---------------------|-------------|---------------------------------------------------------------------------|---------------------|
| `audio_path`        | str \| Path | Path to an audio file.                                                    | _required_          |
| `textgrid_path`     | str \| Path | Path to a TextGrid                                                        | _required_          |
| `entry_classes`     | list        | _description_. Defaults to ["Word", "Phone"].                             | `['Word', 'Phone']` |
